...
let s:sexp_mappings = {
    ...
    \ 'sexp_swap_list_backward':        '<M-k-a-x>',
    \ 'sexp_swap_list_forward':         '<M-j-a-x>',
    \ 'sexp_swap_element_backward':     '<M-h-a-x>',
    \ 'sexp_swap_element_forward':      '<M-l-a-x>',
    \ 'sexp_emit_head_element':         '<M-S-j-a-x>',
    \ 'sexp_emit_tail_element':         '<M-S-k-a-x>',
    \ 'sexp_capture_prev_element':      '<M-S-h-a-x>',
    \ 'sexp_capture_next_element':      '<M-S-l-a-x>',
    \ }
